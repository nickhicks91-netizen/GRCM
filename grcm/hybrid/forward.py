...
from ..modules.phi import PhiModule
...
class EchoGRCMHybrid(nn.Module):
    ...
    def __init__(
        ...
        self.memory = MemoryModule(input_dim=n_nodes, memory_dim=memory_dim)
        self.qualia = QualiaModule(input_dim=n_nodes, num_qualia=4)
        self.phi = PhiModule()
